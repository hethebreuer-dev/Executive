...
export function Nav() {
  ...
  return (
    <div className="absolute top-3 left-3 right-3 sm:top-5 sm:left-5 sm:right-5 z-20">
      <div
        className="flex items-center justify-between rounded-xl border-[0.5px] border-white/[0.18] bg-white/[0.08] px-3.5 py-2.5 sm:px-6 sm:py-3.5 backdrop-blur-md"
      >
